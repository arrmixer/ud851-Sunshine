...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    interface ForecastAdapterOnClickHandler {
        ...
        void accessStringData(String data);
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        // use the getAdapterPosition that returns a int to access the data from the
        // mWeatherData string[] variable
        @Override
        public void onClick(View v) {
            int adapterPosition = getAdapterPosition();
            String weatherForThatDay = mWeatherData[adapterPosition];
            mClickHandler.accessStringData(weatherForThatDay);
            Log.d(TAG, "onClick: " + weatherForThatDay);
        }
