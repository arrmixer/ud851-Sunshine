...
//      TODO (7) Display the weather icon using mDetailBinding
        //get weather ID and use matching method from the SunshineWeatherUtils class
        int weatherId = data.getInt(INDEX_WEATHER_CONDITION_ID);
        mDetailBinding.primaryWeatherInfo.weatherIcon.setImageResource(SunshineWeatherUtils.getLargeArtResourceIdForWeatherCondition(weatherId));
...
//      TODO (17) Create the content description for the high temperature for a11y
        String highTemperatureAlly = getString(R.string.a11y_high_temp, highString);
...
//        mHighTemperatureView.setText(highString);
        ...
        mDetailBinding.primaryWeatherInfo.highTemperature.setContentDescription(highTemperatureAlly);
...
//      TODO (18) Create the content description for the low temperature for a11y
        String lowTemperatureAlly = getString(R.string.a11y_low_temp, lowString);
...
//        mLowTemperatureView.setText(lowString);
        ...
        mDetailBinding.primaryWeatherInfo.lowTemperature.setContentDescription(lowTemperatureAlly);
...
//      TODO (19) Set the content description of the humidity label to the humidity a11y String
        mDetailBinding.extraWeatherDetail.humidityLabel.setContentDescription(humidityAlly);
...
//        mWindView.setText(windString);
        mDetailBinding.extraWeatherDetail.windMeasurement.setText(windString);

//      TODO (22) Set the content description of the wind label to the wind a11y String
        mDetailBinding.extraWeatherDetail.windLabel.setContentDescription(windAlly);
        /************
         * Pressure *
         ************/
...
//      TODO (24) Set the content description of the pressure label to the pressure a11y String
        mDetailBinding.extraWeatherDetail.pressureLabel.setContentDescription(pressureAlly);
