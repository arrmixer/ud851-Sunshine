...
//        int descriptionColumn = mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_DEGREES);
//        int tempMaxColumn = mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_MAX_TEMP);
//        int tempMinColumn = mCursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_MIN_TEMP);

        //get date from cursor and make the data human readable using the Utils classes
        long dateInMillis = mCursor.getLong(MainActivity.INDEX_DATE);
        String dateString = SunshineDateUtils.getFriendlyDateString(mContext, dateInMillis, false);

        // use the weatherId to obtain the proper description using the Utils classes
        int weatherId = mCursor.getInt(MainActivity.INDEX_WEATHER_CONDITION_ID);
        String description = SunshineWeatherUtils.getStringForWeatherCondition(mContext, weatherId);

        // Read the high and low temperatures in celsius and format them using the Utils class
